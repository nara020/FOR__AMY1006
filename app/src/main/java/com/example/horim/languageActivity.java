...
public class languageActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Spinner spinner = (Spinner)findViewById(R.id.after);
        Spinner spinner1 = (Spinner)findViewById(R.id.before);
        ...
        btTranslate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (etSource.getText().toString().length() == 0) {
                    Toast.makeText(languageActivity.this, "번역할 내용을 입력하세요.", Toast.LENGTH_SHORT).show();
    ...
    public class NaverTranslateTask extends AsyncTask<String, Void, String> {
        ...
        //Naver
        String clientId = "mWf3l8QdsRvsLOOISsRt";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "I6pt0RTz9e";//애플리케이션 클라이언트 시크릿값";
